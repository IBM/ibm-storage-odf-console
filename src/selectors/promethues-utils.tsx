 ...
 */
 ...
 export const parseMetricData: parsePrometheusQuery = (queryResult:PrometheusResponse, humanize) =>{
...
type parsePrometheusQuery = (queryResult: PrometheusResponse, humanize: Humanize) => [HumanizeResult, any, number];
