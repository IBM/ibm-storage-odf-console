...
import {
  ...
  getStackChartStats,
  getLegends,
} from '../components/dashboard-page/storage-dashboard-odf/breakdown-card/utils';
...
import {
  ...
  LinkableLegend,
  LinkableLegendProps,
} from '../components/dashboard-page/storage-dashboard-odf/breakdown-card/breakdown-chart';
