export default {
  ...
  "definitions": {
    "SupportedExtension": {
      "anyOf": [
        {
          "$ref": "#/definitions/CreateIBMStorage"
        },
        {
          "$ref": "#/definitions/FeatureFlag"
        },
        {
          "$ref": "#/definitions/FooFeatureFlag"
        },
        {
        ...
        {
          "$ref": "#/definitions/DashboardsOverviewURLSubsystem"
        },
        {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            "id": {
              "type": "string",
              "description": "The ID of this alert. Used to save state if the alert should be shown after dismissed."
            },
            "title": {
              "type": "string",
            ...
            "dismissible": {
              "type": "boolean",
              "description": "Whether to show a dismiss button. false by default"
            }
          },
          "required": [
            "id",
    ...
    "DashboardsInventoryItemGroup": {
      ...
      "properties": {
        "type": {
          "type": "string",
          "const": "console.dashboards/inventory/item/group"
        },
        "properties": {
          "type": "object",
          "properties": {
    ...
    "DashboardsOverviewInventoryItem": {
      ...
      "properties": {
        "type": {
          "type": "string",
          "const": "console.dashboards/inventory/item"
        },
        "properties": {
          "type": "object",
          "properties": {
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "loader": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "Loader for the corresponding action component."
            }
          },
          "required": [
            "k8sResource",
